...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url(); ?>assets/bulog.png">
  <title>
    <?= $title; ?>
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="<?= base_url(); ?>assets/bulog.png" class="navbar-brand-img" alt="main_logo">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav"> 
        <li class="nav-item">
          <a class="nav-link <?= active_menu('Dashboard'); ?>" href="<?= base_url(); ?>Dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= active_menu('Suplayer'); ?>" href="<?= base_url(); ?>Suplayer">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Suplayer</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="<?= base_url(); ?>pages/passets/rofile.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
